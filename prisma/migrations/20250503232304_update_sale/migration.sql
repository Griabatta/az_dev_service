/*
  ...
  - A unique constraint covering the columns `[nmIdCreatedAt]` on the table `SalesWb` will be added. If there are existing duplicate values, this will fail.
  - Added the required column `nmIdCreatedAt` to the `SalesWb` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "wb"."SalesWb" ADD COLUMN     "nmIdCreatedAt" TEXT NOT NULL;

-- CreateIndex
CREATE UNIQUE INDEX "SalesWb_nmIdCreatedAt_key" ON "wb"."SalesWb"("nmIdCreatedAt");
